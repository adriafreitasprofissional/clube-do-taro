  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <div className="rounded-2xl border border-purple-500/40 bg-purple-950/70 p-5 shadow-lg shadow-black/20">
      ...
      {/* CALENDÁRIO */}
      <div className="overflow-hidden rounded-2xl border border-purple-500/40 bg-purple-950/70 shadow-lg shadow-black/20">
