...
export async function GET(
  ...
  const [
    ...
    supabaseAdmin
      .from(
        "therapy_availability_exceptions"
      )
      .select("*")
      .eq(
        "professional",
    ...
    .upsert(
      {
        ...
        client_reschedule_enabled:
          settings.client_reschedule_enabled !==
          false,
        updated_at:
